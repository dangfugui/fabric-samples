...
set -x
SCRIPTSPATH="chaincode_api_list/scripts"
...
#docker exec chaincode bash  chaincode_api_list/scripts/chaincode.sh
docker exec  chaincode  bash  "$SCRIPTSPATH/chaincode.sh"
sleep 10

# docker exec  cli bash chaincode/chaincode_api_list/scripts/cli.sh
